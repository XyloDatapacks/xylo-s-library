...
execute unless score __math__.seed retina.__variable__ matches -2147483648..2147483647 run function xylo_retina:__private__/math_random/setup
...
execute if score $old_version_installed retina.__variable__ matches 1.. run function xylo_retina:__private__/if_else/35
return 1