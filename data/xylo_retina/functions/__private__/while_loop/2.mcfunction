...
execute if score $debug_messages xylo_retina.__variable__ matches 1.. run tellraw @a ["",{"text":"[BOTTOM] ","italic":true,"bold":true},{"text":"Y0: ","color":"white"},{"color":"light_purple","score":{"name":"$Y0","objective":"xylo_retina.__variable__"}}]
