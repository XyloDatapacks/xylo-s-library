execute store result score $horizontal_count retina.__variable__ run data get storage xylo_retina:input HorizontalCount 10
execute store result score $vertical_count retina.__variable__ run data get storage xylo_retina:input VerticalCount 10
execute store result score $centered_count retina.__variable__ run data get storage xylo_retina:input CenteredCount 1
...
execute store result score $spread_least retina.__variable__ run data get storage xylo_retina:input SpreadFactor[0]
execute store result score $spread_most retina.__variable__ run data get storage xylo_retina:input SpreadFactor[1]
...
execute if score $i retina.__variable__ < $horizontal_count retina.__variable__ run function xylo_retina:__private__/for_loop/0
