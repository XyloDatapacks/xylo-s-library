...
execute store result score $entity_frac_X retina.__variable__ run data get storage xylo_retina:data Pos[0] 480
...
execute store result score $entity_frac_Y retina.__variable__ run data get storage xylo_retina:data Pos[1] 480
scoreboard players set $temp retina.__variable__ 480
...
execute store result score $entity_frac_Z retina.__variable__ run data get storage xylo_retina:data Pos[2] 480
scoreboard players set $temp retina.__variable__ 480
