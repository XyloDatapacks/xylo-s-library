...
execute unless score $expand_entity_hitboxes retina.__variable__ = $expand_entity_hitboxes retina.__variable__ run function xylo_retina:__private__/if_else/5
execute if score __if_else__ retina.__variable__ matches 0 run function xylo_retina:__private__/if_else/6
