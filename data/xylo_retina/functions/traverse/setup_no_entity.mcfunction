...
execute store result score $override_executing retina.__variable__ run data get storage xylo_retina:input OverrideExecutingEntity
data remove storage xylo_retina:input OverrideExecutingEntity
execute if data storage xylo_retina:input ExpandEntityHitboxes store result score $expand_entity_hitboxes retina.__variable__ run data get storage xylo_retina:input ExpandEntityHitboxes 480
...
data remove storage xylo_retina:input ExpandEntityHitboxes
execute store result score $ignore_blocks retina.__variable__ run data get storage xylo_retina:input IgnoreBlocks
data remove storage xylo_retina:input IgnoreBlocks
...
execute summon minecraft:marker run function xylo_retina:__private__/anonymous/1
