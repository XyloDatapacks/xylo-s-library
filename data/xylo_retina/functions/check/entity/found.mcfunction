...
tag @e[type=!#xylo_retina:intangible] remove retina.possible_target
execute unless score $expand_entity_check retina.__variable__ = $expand_entity_check retina.__variable__ align xyz as @e[type=!#xylo_retina:intangible,tag=!retina.executing,dx=0,dy=0,dz=0] at @s run function xylo_retina:check/entity/get_hitbox
execute if score $expand_entity_check retina.__variable__ = $expand_entity_check retina.__variable__ align xyz positioned ~-1 ~-1 ~-1 as @e[type=!#xylo_retina:intangible,tag=!retina.executing,dx=1,dy=1,dz=1] at @s run function xylo_retina:check/entity/get_hitbox
