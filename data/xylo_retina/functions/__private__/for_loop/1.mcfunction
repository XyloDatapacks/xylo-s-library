...
execute if score $horizontal_count retina.__variable__ matches 10 run function xylo_retina:__private__/if_else/1
...
execute if score $vertical_count retina.__variable__ matches 10 run function xylo_retina:__private__/if_else/2
scoreboard players operation __math__.rng.bound retina.__variable__ = $spread_most retina.__variable__
scoreboard players operation __math__.rng.bound retina.__variable__ -= $spread_least retina.__variable__
scoreboard players add __math__.rng.bound retina.__variable__ 1
function xylo_retina:__private__/math_random/main
...
execute if score $j retina.__variable__ < $vertical_count retina.__variable__ run function xylo_retina:__private__/for_loop/1