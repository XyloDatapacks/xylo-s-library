...
$execute at @s positioned $(x) $(y) $(z) store result score #xlib.internal.blocks.place.move_at_place_position.result xlib.op run function xylo_library:internal/blocks/place/place with storage xylo_library:op place_block.tag.xylo_library.block
