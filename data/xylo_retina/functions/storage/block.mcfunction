...
execute if score $nearest_axis retina.__variable__ matches 0 run function xylo_retina:__private__/if_else/23
...
execute if score $nearest_axis retina.__variable__ matches 1 run function xylo_retina:__private__/if_else/24
...
execute if score $nearest_axis retina.__variable__ matches 2 run function xylo_retina:__private__/if_else/25
