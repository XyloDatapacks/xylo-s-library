...
tp @s ~ ~ ~ ~ ~
data modify storage xylo_retina:operations setup_context set from entity @s {}
execute unless score $override_pitch retina.__variable__ = $override_pitch retina.__variable__ store result score $input_pitch retina.__variable__ run data get storage xylo_retina:operations setup_context.Rotation[1] 10
...
execute unless score $override_yawn retina.__variable__ = $override_yawn retina.__variable__ store result score $input_yaw retina.__variable__ run data get storage xylo_retina:operations setup_context.Rotation[0] 10
...
execute store result score $X retina.__variable__ run data get storage xylo_retina:operations setup_context.Pos[0] 480
execute store result score $Y retina.__variable__ run data get storage xylo_retina:operations setup_context.Pos[1] 480
execute store result score $Z retina.__variable__ run data get storage xylo_retina:operations setup_context.Pos[2] 480
execute store result score $overflow_check_X retina.__variable__ run data get storage xylo_retina:operations setup_context.Pos[0] 1
execute store result score $overflow_check_Z retina.__variable__ run data get storage xylo_retina:operations setup_context.Pos[2] 1
kill @s