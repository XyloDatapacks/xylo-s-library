execute store result score $X0 retina.__variable__ run data get storage xylo_retina:data List[-1][0]
execute store result score $X1 retina.__variable__ run data get storage xylo_retina:data List[-1][3]
...
execute store result score $Y0 retina.__variable__ run data get storage xylo_retina:data List[-1][1]
execute store result score $Y1 retina.__variable__ run data get storage xylo_retina:data List[-1][4]
...
execute store result score $Z0 retina.__variable__ run data get storage xylo_retina:data List[-1][2]
execute store result score $Z1 retina.__variable__ run data get storage xylo_retina:data List[-1][5]
