...
execute unless score $override_pitch retina.__variable__ matches 1 store result score $input_pitch retina.__variable__ run data get storage xylo_retina:operations setup_context.Rotation[1] 10
...
execute unless score $override_yawn retina.__variable__ matches 1 store result score $input_yaw retina.__variable__ run data get storage xylo_retina:operations setup_context.Rotation[0] 10
