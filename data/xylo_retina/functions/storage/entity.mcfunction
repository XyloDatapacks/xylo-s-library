...
execute as @e[type=!#xylo_retina:ignore,tag=retina.possible_target] if score @s retina.id = $closest_cuboid_id retina.__variable__ run function xylo_retina:__private__/anonymous/10
...
execute if score $nearest_axis retina.__variable__ matches 1 run function xylo_retina:__private__/if_else/27
