...
execute store result storage xylo_retina:output TargetedBlock[0] int 1 run scoreboard players get $int_X retina.__variable__
execute store result storage xylo_retina:output PlacingPosition[0] int 1 run scoreboard players get $prev_X retina.__variable__
...
execute if score $nearest_axis retina.__variable__ matches 0 run function xylo_retina:__private__/if_else/28
execute store result storage xylo_retina:output TargetedBlock[1] int 1 run scoreboard players get $int_Y retina.__variable__
execute store result storage xylo_retina:output PlacingPosition[1] int 1 run scoreboard players get $prev_Y retina.__variable__
scoreboard players operation $targeted_Y retina.__variable__ += $origin_Y retina.__variable__
execute store result storage xylo_retina:output ContactCoordinates[1] double 0.0020833333333333333 run scoreboard players get $targeted_Y retina.__variable__
execute if score $nearest_axis retina.__variable__ matches 1 run function xylo_retina:__private__/if_else/29
execute store result storage xylo_retina:output TargetedBlock[2] int 1 run scoreboard players get $int_Z retina.__variable__
execute store result storage xylo_retina:output PlacingPosition[2] int 1 run scoreboard players get $prev_Z retina.__variable__
...
execute if score $nearest_axis retina.__variable__ matches 2 run function xylo_retina:__private__/if_else/30
...
execute if data storage xylo_retina:input {EndpointEntity: true} summon minecraft:marker run function xylo_retina:__private__/anonymous/10