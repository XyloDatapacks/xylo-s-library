...
execute as @e[type=!#xylo_retina:ignore,tag=retina.possible_target] if score @s retina.id = $closest_cuboid_id retina.__variable__ run function xylo_retina:__private__/anonymous/11
data modify storage xylo_retina:data Entity set from entity @e[type=!#xylo_retina:ignore,tag=retina.target,limit=1]
...
execute if score $expand_entity_hitboxes retina.__variable__ = $expand_entity_hitboxes retina.__variable__ run function xylo_retina:__private__/if_else/31
...
execute if score $nearest_axis retina.__variable__ matches 0 run function xylo_retina:__private__/if_else/32
...
execute if score $nearest_axis retina.__variable__ matches 1 run function xylo_retina:__private__/if_else/33
...
execute if score $nearest_axis retina.__variable__ matches 2 run function xylo_retina:__private__/if_else/34
...
execute if data storage xylo_retina:input {EndpointEntity: true} summon minecraft:marker run function xylo_retina:__private__/anonymous/12