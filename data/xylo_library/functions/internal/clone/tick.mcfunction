...
execute if score #xlib.internal.clone.tick.hitbox_death xlib.op matches 1 on vehicle on passengers if entity @s[tag=xlib.internal.clone.hitbox] run team join xlib.no_collision @s
